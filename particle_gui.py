...
class ParticleUI :
    def __init__(self) :
        ...
        # Plane
        plane = c_lib.getGroundPlaneCollider(self.context, 0)
        plane.dir = [plane.normal[1], -1*plane.normal[0]]
        pos1 = [self.worldToView((plane.point[0]-100*plane.dir[0], plane.point[1]-100*plane.dir[1])), 
                self.worldToView((plane.point[0]+100*plane.dir[0], plane.point[1]+100*plane.dir[1]))]
        draw_id = self.canvas.create_line(pos1, fill="blue")
